...
# plutil.pl
# Convert to/from binary/text plist file
# Original: http://scw.us/iPhone/plutil/
# Copyright 2007-2008 Starlight Computer Wizardry
# Copyright 2015 HearthSim.info
...
sub NewName {
	...
	# print STDERR "Old: $oldname, from: $fromtype, to: $totype\n";
...
# get trailer
	...
	# print STDERR "Offsets are $OffsetSize bytes\n";
	# print STDERR "Object Refs are $ObjRefSize bytes\n";
	# print STDERR "There are $NumObjects objects in the file\n";
	# print STDERR "The top object is at $TopObject\n";
	# print STDERR "The Offset Table is at offset $OffsetTableOffset\n\n";
...
# get the offset table
	...
	# print STDERR "Int Lengths = $ILen\n";
	# print STDERR "Misc Lengths = $MLen\n";
	# print STDERR "String Lengths = $SLen\n";
	# print STDERR "Unique Strings = ",scalar keys %RStrings,"\n";
...
if ((@ARGV > 0) && (-e $ARGV[0])) {
	...
	print STDERR "usage: plutil file[.text|.binary][.plist|.strings|.*]\n";
}
